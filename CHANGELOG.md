...
- feat: add upload folder detection (Luis Vendrame)
...
- feat: REST routes for {auth}/users (Luis Vendrame)
...
- fix: hot-reload only for modifications (Luis Vendrame)
...
- feat: generator
- feat: ssl option for https connection
- fix: reject a duplicated id for rest post
- feat: load collections and schemas
