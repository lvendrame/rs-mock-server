...
pub fn create_get_all(app: &mut App, route: &str, is_protected: bool, collection: &Arc<DbCollection>) {
...
pub fn create_insert(app: &mut App, route: &str, is_protected: bool, collection: &Arc<DbCollection>) {
...
pub fn create_get_item(app: &mut App, id_route: &str, is_protected: bool, collection: &Arc<DbCollection>) {
...
pub fn create_full_update(app: &mut App, id_route: &str, is_protected: bool, collection: &Arc<DbCollection>) {
...
pub fn create_partial_update(app: &mut App, id_route: &str, is_protected: bool, collection: &Arc<DbCollection>) {
...
pub fn create_delete(app: &mut App, id_route: &str, is_protected: bool, collection: &Arc<DbCollection>) {
